...
## Rhinocerous Tab Button List

`buttons.yaml` file contains a list of all UI components in Rhinocerous tab (inside Revit UI) and is generated automatically on every new {{ site.terms.rir }} build. The wiki uses this information to generate a documentation page for all the available UI components.
