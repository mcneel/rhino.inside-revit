...
<table style="width:100%">
  ...
  <tr>
    <td><img src="/images/GH/GeometricElement.png" alt="Geometric by Element" width="32"></td>
  ...
  <tr>
    <td><img src="/images/GH/Host.png" alt="Host" width="32"></td>
    <td>Host</td>
    <td>Represents a Revit document host element.</td>
  </tr>
  <tr>
      <td><img src="/images/GH/Edge.png" alt="Edge" width="32"></td>
      <td>Edge</td>
      <td>Represents a Revit edge from an element.</td>
  </tr>
  <tr>
      <td><img src="/images/GH/Face.png" alt="Face" width="32"></td>
      <td>Face</td>
      <td>Select a Revit Element Face(s)</td>
  </tr>
  <tr>
      <td><img src="/images/GH/SketchPlane.png" alt="SketchPlane" width="32"></td>
      <td>Sketch Plane</td>
      <td>Represents a Revit document sketch plane. (Selector in the future)</td>
   </tr>
  <tr>
      <td><img src="/images/GH/Vertex.png" alt="Vertex" width="32"></td>
      <td>Vertex</td>
      <td>Select a Revit Element Vertex(s)</td>
   </tr>
   <tr>
    <td><img src="/images/GH/Category.png" alt="BeamByCurve" width="32"></td>
    <td>Category</td>
    <td>Revit Category Param used for selecting persistent Category (future)</td>
  </tr>
  <tr>
    <td><img src="/images/GH/GeometricElement.png" alt="GeometricElement" width="32"></td>
    <td>Geometric Element</td>
    <td>Select one or more persistent Element(s) in Revit to be used in Grasshopper. Also can be used to convert a sub-part to the parent element</td>
  </tr>
  <tr>
    <td><img src="/images/GH/ElementType.png" alt="ElementType" width="32"></td>
    <td>Element Type</td>
    <td>Get Element type from the Element(s) input</td>
  </tr>
  <tr>
    <td><img src="/images/GH/Family.png" alt="Family" width="32"></td>
    <td>Family</td>
    <td>Represents a Revit document family.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/GraphicStyle.png" alt="GraphicStyle" width="32"></td>
    <td>Graphic Style</td>
    <td>Represents a Revit Graphic Style.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/Level.png" alt="Level" width="32"></td>
    <td>Level</td>
    <td>Represents a Revit Level</td>
  </tr>
  <tr>
    <td><img src="/images/GH/BuiltInParameterGroup.png" alt="BuiltInParameterGroup" width="32"></td>
    <td>Parameter Group</td>
    <td>Represents a Revit Parameter Group</td>
  </tr>
  <tr>
      <td><img src="/images/GH/ParameterKey.png" alt="ParameterKey" width="32"></td>
      <td>Parameter Key</td>
...
<table style="width:100%">
 ...
  <tr>    
      <td width="48px"><img src="/images/GH/AdaptiveComponentByPoints.png" alt="AdaptiveComponentByPoints" width="32"></td>    
    ...
    <tr>
    <td width="48px"><img src="/images/GH/BeamByCurve.png" alt="AddBeamByCurve" width="32"></td>
    <td>Add Beam By Curve</td>
    <td>Create a Revit Beam Object using a 2d or 3d curve for an axis/  Also assign a level.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/ColumnByCurve.png" alt="AddColumnByCurve" width="32"></td>
    <td>Add Column By Curve</td>
    <td>Create a Revit Column Object using an axial curve</td>
  </tr>
  <tr>
    <td><img src="/images/GH/FamilyInstanceByLocation.png" alt="FamilyInstanceByLocation" width="32"></td>
  ...
  <tr>
    <td><img src="/images/GH/FloorByOutline.png" alt="AddFloorByOutline" width="32"></td>
    <td>Add Floor By Outline</td>
    <td>Create a Revit Floor using a plan curve</td>
  </tr>
  <tr>
    <td><img src="/images/GH/RoofByOutline.png" alt="RoofByOutline" width="32"></td>
    <td>Add Roof By Outline</td>
    <td>Create a Revit Roof by using a boundary curve, type and level.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/WallByCurve.png" alt="ColumnByCurve" width="32"></td>
    <td>Wall By Curve</td>
  ...
  <tr>
    <td><img src="/images/GH/DirectShapeByLocation.png" alt="DirectShapeByLocation" width="32"></td>
...
<table style="width:100%">
 ...
  <tr>
      <td width="48px"><img src="/images/GH/CategoryGraphicStyle.png" alt="CategoryGraphicStyle" width="32"></td>
      <td>Category Graphic Style</td>
      <td>Returns the Projections an Cut of a specifcs categories graphic style.</td>
  </tr>
  <tr>
    <td width="48px"><img src="/images/GH/CategoryIdentity.png" alt="CategoryIdentity" width="32"></td>
  ...
  <tr>
    <td width="48px"><img src="/images/GH/CategoryObjectStyles.png" alt="CategoryObjectStyles" width="32"></td>
    <td>Category Object Styles</td>
    <td>Returns category object style attributes like Line-Color, Material…</td>
  </tr>
  <tr>
    <td width="48px"><img src="/images/GH/CategorySubCategories.png" alt="CategorySubCategories" width="32"></td>
    <td>Category SubCategories</td>
    <td>Returns a list of all the subcategories of Category</td>
  </tr>
  <tr>
    <td><img src="/images/GH/CategoryTypes.png" alt="ColumnByCurve" width="32"></td>
    <td>Category Types</td>
    <td>A pick list of category types in Revit.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/DirectShapeCategories.png" alt="DirectShapeCategories" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/GridByCurve.png" alt="GridByCurve" width="32"></td>
    <td>Add Grid by Curve</td>
    <td>Add a Revit Grid line through a Rhino curve.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/LevelByElevation.png" alt="LevelByElevation" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/DocumentCategories.png" alt="BeamByCurve" width="32"></td>
    <td>Document Categories</td>
    <td>Get Active Document Category list Using the Type, and HasMaterial filter.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/DocumentElements.png" alt="BeamByCurve" width="32"></td>
    <td>Document Elements</td>
    <td>Get Active Document Elements list using a Category filter</td>
  </tr>
  <tr>
    <td><img src="/images/GH/DocumentElementTypes.png" alt="ColumnByCurve" width="32"></td>
    <td>Document Element Types</td>
    <td>Get Active Document Element Types using the Category, Family and Type filter</td>
  </tr>
  <tr>
    <td><img src="/images/GH/DocumentLevels.png" alt="BeamByCurve" width="32"></td>
    <td>Document Levels</td>
    <td>Get Active Document levels list from Revit</td>
  </tr>
  <tr>
    <td><img src="/images/GH/DocumentParameters.png" alt="ColumnByCurve" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/ElementDecompose.png" alt="BeamByCurve" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/FamilyGetType.png" alt="FamilyGetType" width="32"></td>
    <td>Family Get Type</td>
    <td>Obtains a set of types that are owned by Family</td>
  </tr>
  <tr>
    <td><img src="/images/GH/FamilyLoad.png" alt="FamilyLoad" width="32"></td>
    <td>Load Family</td>
    <td>Loads a family into the document using optional overrides</td>
  </tr>
  <tr>
    <td><img src="/images/GH/FamilyNew.png" alt="FamilyNew" width="32"></td>
    <td>Load Family</td>
    <td>Creates a new Family from a template including optional overrides</td>
  </tr>
  <tr>
    <td><img src="/images/GH/FamilySaveAs.png" alt="FamilySaveAs" width="32"></td>
    <td>Family Save As...</td>
    <td>Saves the Family to a given file path.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/AddFamilyElementByBrep.png" alt="AddFamilyElementByBrep" width="32"></td>
    <td>Add Family By Brep</td>
    <td>Add a family using a Brep.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/AddFamilyElementByCurve.png" alt="AddFamilyElementByCurve" width="32"></td>
    <td>Add Family by Curve</td>
    <td>Add a family using curve objects.</td>
  </tr>
  <tr>
      <td><img src="/images/GH/VisibilityConstruct.png" alt="VisibilityConstruct" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/ElementExclusionFilter.png" alt="ElementExclusionFilter" width="32"></td>
    <td>Element Exclusion Filter</td>
    <td>Filter used to exclude a set of elements.</td>
  </tr>
  <tr>
    <td><img src="/images/GH/ElementLogicalOrFilter.png" alt="ElementLogicalOrFilter" width="32"></td>
    <td>Element Logical Or Filter</td>
    <td>Filter used to combine a set of filters that pass when any pass</td>
  </tr>
  <tr>
    <td><img src="/images/GH/ElementLogicalAndFilter.png" alt="ElementLogicalAndFilter.png" width="32"></td>
    <td>Element Logical And Filter.png</td>
    <td>Filter used to combine a set of filters that pass when any pass</td>
  </tr>
  <tr>
    <td><img src="/images/GH/ElementCategoryFilter.png" alt="ElementCategoryFilter" width="32"></td>
    <td>Element Category Filter</td>
    <td>Filter used to match elements by their category</td>
  </tr>
  <tr>
    <td><img src="/images/GH/ElementExcludeElementType.png" alt="ElementExcludeElementType" width="32"></td>
    <td>Element Exclude Element Type</td>
    <td>Filter used to exclude element types</td>
  </tr>
  <tr>
      <td><img src="/images/GH/ElementClassFilter.png" alt="EElementClassFilter" width="32"></td>
      <td>Element Class Filter</td>
      <td>Filter used to match elements by their API class</td>
  </tr>
  <tr>
      <td><img src="/images/GH/ElementTypeFilter.png" alt="ElementTypeFilter" width="32"></td>
      <td>Element Type Filter</td>
      <td>Filter used to match elements by their type</td>
  </tr>
  <tr>
      <td><img src="/images/GH/ElementBoundingBoxFilter.png" alt="lementBoundingBoxFilter" width="32"></td>
 ...
  <tr>
      <td><img src="/images/GH/ElementRuleLess.png" alt="ElementRuleLess" width="32"></td>
      <td>Element Rule Less</td>
      <td>Filter used to match elements if value of a parameter less than Value</td>
  </tr>
  <tr>
      <td><img src="/images/GH/ElementRuleLessOrEqual.png" alt="ElementRuleLessOrEqual" width="32"></td>
      <td>Element Rule Less Or Equal</td>
      <td>Filter used to match elements if value of a parameter less or equal than Value</td>
  </tr>
  <tr>
      <td><img src="/images/GH/ElementRuleNotEquals.png" alt="ElementRuleNotEquals" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/DirectShapeByBrep.png" alt="DirectShapeByBrep" width="32"></td>
    <td>Add Brep by Shape</td>
    <td>Given a Brep, it adds a Brep element to the active Revit document</td>
  </tr>
  <tr>
    <td><img src="/images/GH/DirectShapeByCurve.png" alt="DirectShapeByCurve" width="32"></td>
    <td>Add Curve Shape</td>
    <td>Given a Curve, it adds a Curve shape to the active Revit document</td>
  </tr>
  <tr>
    <td><img src="/images/GH/DirectShapeByMesh.png" alt="DirectShapeByMesh" width="32"></td>
    <td>Add Mesh Shape</td>
    <td>Given a Mesh, it adds a Mesh element to the active Revit document</td>
  </tr>
  <tr>
    <td><img src="/images/GH/DirectShapeByPoint.png" alt="DirectShapeByPoint" width="32"></td>
    <td>Add Point Shape</td>
    <td>Given a Point, it adds a Point element to the active Revit document</td>
  </tr>
  <tr>
      <td><img src="/images/GH/DirectShapeByGeometry.png" alt="AddDirectShapeByGeometry" width="32"></td>    <td>Add DirectShape Geometry</td>    <td>Create a Directshape Element from a Rhino Geometry. This is the most flexible way to import Geometry.</td>  
    </tr>
</table>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/HostObjectGetFaces.png" alt="HostObjectGetFaces" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/BuiltInParameterByName.png" alt="BeamByCurve" width="32"></td>
 ...
  <tr>
      <td><img src="/images/GH/ModelCategoriesPicker.png" alt="ModelCategoriesPicker" width="32"></td>
  ...
  <tr>
      <td><img src="/images/GH/AnnotationCategoriesPicker.png" alt="AnnotationCategoriesPicker" width="32"></td>
    ...
    <tr>
        <td><img src="/images/GH/AnalyticalCategoriesPicker.png" alt="AnalyticalCategoriesPicker" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/FormByCurves.png" alt="BeamByCurve" width="32"></td>
    <td>Add form by Curve</td>
    <td>Given a list of curves, it adds a Form element to the active Revit document</td>
  </tr>
  <tr>
    <td><img src="/images/GH/FormByGeometry.png" alt="BeamByCurve" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/ModelLineByCurve.png" alt="BeamByCurve" width="32"></td>
    <td>Add Model Line by Curve</td>
    <td>Given a Curve, it adds a Curve element to the active Revit document</td>
  </tr>
  <tr>
    <td><img src="/images/GH/SketchPlaneByPlane.png" alt="BeamByCurve" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/ParameterByName.png" alt="BeamByCurve" width="32"></td>
    <td>Add Document Parameter by Name</td>
    <td>Given its Name, it adds a Parameter definition to the active Revit document</td>
  </tr>
  <tr>
    <td><img src="/images/GH/ParameterKeyDecompose.png" alt="BeamByCurve" width="32"></td>
    <td>Decompose a Parameter Key</td>
    <td>Decompose a parameter key into Name, Value Type, Visible Property and ID</td>
  </tr>
  <tr>
    <td><img src="/images/GH/ParameterValueDecompose.png" alt="BeamByCurve" width="32"></td>
    <td>Decompose a Parameter Value</td>
    <td>Decompose a parameter value into Name, Value Type, Visible Property and ID</td>
  </tr>
  <tr>
    <td width="48px"><img src="/images/GH/BuiltInParameterGroup.png" alt="BeamByCurve" width="32"></td>
    <td>Parameter Group</td>
    <td>Represent Revit Paramter Group</td>
  </tr>
  <tr>
    <td><img src="/images/GH/BuiltInParameterGroups.png" alt="BeamByCurve" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/BuildingPadByOutline.png" alt="BeamByCurve" width="32"></td>
  ...
  <tr>
    <td><img src="/images/GH/TopographyByPoints.png" alt="BeamByCurve" width="32"></td>
...
<table style="width:100%">
  ...
  <tr>
    <td width="48px"><img src="/images/GH/ElementTypeDuplicate.png" alt="ElementTypeDuplicate" width="32"></td>
    <td>Duplicate an Element Type.</td>
    <td>Given a Name, it duplicates an ElementType into the active Revit document</td>
  </tr>
  <tr>
    <td><img src="/images/GH/ElementTypeIdentity.png" alt="ElementTypeIdentity" width="32"></td>
  ...
  <tr>
    <td><img src="/images/GH/ElementTypeSimiliar.png" alt="ElementTypeSimiliar" width="32"></td>
    <td>Select Similiar Types</td>
      <td> Selects the types that are Similiar to the input Type.</td>
    </tr>
  <tr>
    <td><img src="/images/GH/AddDirectShapeByType.png" alt="AddDirectShapeType" width="32"></td>
