...
namespace RhinoInside.Revit.GH.Components.Views
{
  ...
  public class AddSectionView : ElementTrackerComponent
  {
    public override Guid ComponentGuid => new Guid("369B6109-D1C7-486A-A25F-6695719043A4");
    public override GH_Exposure Exposure => GH_Exposure.tertiary;
    protected override string IconTag => string.Empty;

    public AddSectionView() : base
    (
      name: "Add Section View",
