...
namespace RhinoInside.Revit.GH.Components.Level
{
  public class LevelIdentity : TransactionalChainComponent
  {
    ...
    static readonly ParamDefinition[] inputs =
    {
      ...
      ParamDefinition.Create<Parameters.Elevation>("Elevation", "E", "Level elevation", optional: true, relevance: ParamVisibility.Default),
      ParamDefinition.Create<Param_Boolean>("Structural", "S", "Level is structural", optional: true, relevance: ParamVisibility.Default),
      ParamDefinition.Create<Param_Boolean>("Building Story", "BS", "Level is building story", optional: true, relevance: ParamVisibility.Default),
    };

    protected override ParamDefinition[] Outputs => outputs;
    static readonly ParamDefinition[] outputs =
    {
      ParamDefinition.Create<Parameters.Level>("Level", "L", relevance: ParamVisibility.Voluntary),
      ...
      ParamDefinition.Create<Param_Boolean>("Structural", "S", "Level is structural", relevance: ParamVisibility.Default),
      ParamDefinition.Create<Param_Boolean>("Building Story", "BS", "Level is building story", relevance: ParamVisibility.Default),
      ParamDefinition.Create<Parameters.View>("Plan View", "PV", "Associated plan view", relevance: ParamVisibility.Voluntary),
    };
