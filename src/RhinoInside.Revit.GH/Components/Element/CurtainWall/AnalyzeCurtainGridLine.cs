...
namespace RhinoInside.Revit.GH.Components
{
  public class AnalyseCurtainGridLine : AnalysisComponent
  {
    ...
    protected override void TrySolveInstance(IGH_DataAccess DA)
    {
      ...
      DA.SetData("Curve", gridLine.FullCurve.ToRhino());
      DA.SetDataList("Segments", gridLine.AllSegmentCurves.ToRhino());
      DA.SetDataList("Existing Segments", gridLine.ExistingSegmentCurves.ToRhino());
      DA.SetDataList("Skipped Segments", gridLine.SkippedSegmentCurves.ToRhino());
