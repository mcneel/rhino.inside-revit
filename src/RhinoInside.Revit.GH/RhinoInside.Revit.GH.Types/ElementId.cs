...
namespace RhinoInside.Revit.GH.Types
{
  public class ElementId : GH_Goo<DB.ElementId>, IEquatable<ElementId>, IGH_ElementId
  {
    ...
    public static ElementId FromElementId(DB.Document doc, DB.ElementId id)
    {
      ...
      if (Documents.Categories.Category.FromElementId(doc, id) is Documents.Categories.Category c)
        return c;

      if (Documents.Params.ParameterKey.FromElementId(doc, id) is Documents.Params.ParameterKey p)
        return p;
