...
namespace RhinoInside.Revit.GH.Components.Elements.Material
{
  public class MaterialIdentity : Component
  {
    ...
    {
      manager.AddParameter(new Parameters.Elements.Material.Material(), "Material", "Material", string.Empty, GH_ParamAccess.item);
    }
