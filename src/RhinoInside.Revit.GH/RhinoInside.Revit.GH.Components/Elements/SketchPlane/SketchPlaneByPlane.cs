...
namespace RhinoInside.Revit.GH.Components.Elements.SketchPlane
{
  public class SketchPlaneByPlane : ReconstructElementComponent
  {
    ...
    {
      manager.AddParameter(new Parameters.Elements.SketchPlane.SketchPlane(), "SketchPlane", "P", "New SketchPlane", GH_ParamAccess.item);
    }
