...
namespace RhinoInside.Revit.GH.Components.Elements
{
  public class ElementMaterialQuanities : Component
  {
    ...
    protected override void RegisterInputParams(GH_InputParamManager manager)
    {
      ...
      manager[manager.AddParameter(new Parameters.Elements.Material.Material(), "Materials", "M", "Materials used to build this element", GH_ParamAccess.list)].Optional = true;
      manager[manager.AddParameter(new Parameters.Elements.Material.Material(), "Paint",     "P", "Material used to paint this element",  GH_ParamAccess.list)].Optional = true;
    }
