...
namespace RhinoInside.Revit.GH.Components.Elements.BuildingPad
{
  public class BuildingPadByOutline : ReconstructElementComponent
  {
    ...
    {
      manager.AddParameter(new Parameters.Elements.HostObject.HostObject(), "BuildingPad", "BP", "New BuildingPad", GH_ParamAccess.item);
    }
