...
namespace RhinoInside.Revit.GH.Components.Elements.Wall
{
  public class WallByCurve : ReconstructElementComponent
  {
    ...
    {
      manager.AddParameter(new Parameters.Elements.HostObject.HostObject(), "Wall", "W", "New Wall", GH_ParamAccess.item);
    }
