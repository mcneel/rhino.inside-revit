...
namespace RhinoInside.Revit.GH.Components.Floor
{
  public class FloorByOutline : ReconstructElementComponent
  {
    ...
    {
      manager.AddParameter(new Parameters.Elements.HostObject.HostObject(), "Floor", "F", "New Floor", GH_ParamAccess.item);
    }
