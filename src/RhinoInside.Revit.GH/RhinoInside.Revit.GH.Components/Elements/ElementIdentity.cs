...
namespace RhinoInside.Revit.GH.Components.Elements
{
  public class ElementIdentity : Component
  {
    ...
    {
      manager.AddParameter(new Parameters.Documents.Categories.Category(), "Category", "C", "Category in which the Element resides", GH_ParamAccess.item);
      manager.AddParameter(new Parameters.Documents.ElementTypes.ElementType(), "Type", "T", "ElementType of the Element", GH_ParamAccess.item);
