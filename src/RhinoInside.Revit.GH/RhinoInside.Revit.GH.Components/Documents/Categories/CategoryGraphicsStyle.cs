...
namespace RhinoInside.Revit.GH.Components.Documents.Categories
{
  public class CategoryGraphicsStyle : Component
  {
    ...
    {
      manager.AddParameter(new Parameters.Documents.Styles.GraphicsStyle(), "Projection", "P", string.Empty, GH_ParamAccess.list);
      manager.AddParameter(new Parameters.Documents.Styles.GraphicsStyle(), "Cut", "C", string.Empty, GH_ParamAccess.list);
    }
