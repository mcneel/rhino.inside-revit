...
namespace RhinoInside.Revit.GH.Components.Documents.Categories
{
  public class CategoryParameters : Component
  {
    ...
    {
      manager.AddParameter(new Parameters.Documents.Categories.Category(), "Category", "C", "Category", GH_ParamAccess.item);
    }

    protected override void RegisterOutputParams(GH_OutputParamManager manager)
    {
      manager.AddParameter(new Parameters.Documents.Params.ParameterKey(), "ParameterKeys", "K", "Parameter definitions list", GH_ParamAccess.list);
    }
    ...
    protected override void TrySolveInstance(IGH_DataAccess DA)
    {
      ...
      if(category.Document() is DB.Document doc)
      {
        ...
        DA.SetDataList("ParameterKeys", parameterKeys.Select(paramId => Types.Documents.Params.ParameterKey.FromElementId(doc, paramId)));
      }
    }
  }
}
