...
namespace RhinoInside.Revit.GH.Components.Documents.Categories
{
  public class CategoryIdentity : Component
  {
    ...
    {
      manager.AddParameter(new Parameters.Documents.Categories.Category(), "Category", "C", "Category to query", GH_ParamAccess.item);
    }

    protected override void RegisterOutputParams(GH_OutputParamManager manager)
    {
      manager.AddTextParameter("Name", "N", "Category name", GH_ParamAccess.item);
      manager.AddParameter(new Parameters.Documents.Categories.Category(), "Parent", "P", "Category parent category", GH_ParamAccess.item);
      manager.AddParameter(new Param_Enum<Types.Documents.Categories.CategoryType>(), "Type", "T", "Category type", GH_ParamAccess.item);
