...
namespace RhinoInside.Revit.GH.Components.Documents
{
  public class DocumentCategories : DocumentComponent
  {
    ...
    protected override void RegisterInputParams(GH_InputParamManager manager)
    {
      ...
      var type = manager[manager.AddParameter(new Param_Enum<Types.Documents.Categories.CategoryType>(), "Type", "T", "Category type", GH_ParamAccess.item)] as Param_Enum<Types.Documents.Categories.CategoryType>;
    ...
    {
      manager.AddParameter(new Parameters.Documents.Categories.Category(), "Categories", "Categories", "Categories list", GH_ParamAccess.list);
    }
