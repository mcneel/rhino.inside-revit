...
namespace RhinoInside.Revit.GH.Components.Documents
{
  public class DocumentElementTypes : DocumentComponent
  {
    ...
    {
      manager.AddParameter(new Parameters.Documents.ElementTypes.ElementType(), "ElementTypes", "T", "Requested element type", GH_ParamAccess.list);
    }
    ...
    protected override void TrySolveInstance(IGH_DataAccess DA, DB.Document doc)
    {
      ...
      using (var collector = new DB.FilteredElementCollector(doc))
      {
        ...
        DA.SetDataList("ElementTypes", elementTypes.Select(x => new Types.Documents.ElementTypes.ElementType(x)));
      }
    }
