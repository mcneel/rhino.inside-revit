...
namespace RhinoInside.Revit.GH.Types
{
  ...
  public partial class Element
  {
    ...
    static readonly Dictionary<Type, Func<ARDB.Element, Element>> ActivatorDictionary = new Dictionary<Type, Func<ARDB.Element, Element>>()
    {
      ...
      { typeof(ARDB.Architecture.ContinuousRail),     (element)=> new ContinuousRail        (element as ARDB.Architecture.ContinuousRail) },
#if REVIT_2023
      ...
      { typeof(ARDB.Structure.AnalyticalPanel),       (element)=> new AnalyticalPanel       (element as ARDB.Structure.AnalyticalPanel) },
      { typeof(ARDB.Structure.AnalyticalOpening),     (element)=> new AnalyticalOpening     (element as ARDB.Structure.AnalyticalOpening) },
#else
