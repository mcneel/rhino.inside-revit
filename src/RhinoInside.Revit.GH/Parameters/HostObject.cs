...
namespace RhinoInside.Revit.GH.Parameters
{
  ...
  public class CurtainGridLine : GraphicalElementT<Types.HostObject, DB.CurtainGridLine>
  {
    public override GH_Exposure Exposure => GH_Exposure.tertiary;
  ...
  public class CurtainSystem : GraphicalElementT<Types.HostObject, DB.CurtainSystem>
  {
    public override GH_Exposure Exposure => GH_Exposure.tertiary;
  ...
  public class Ceiling : GraphicalElementT<Types.HostObject, DB.Ceiling>
  {
    public override GH_Exposure Exposure => GH_Exposure.tertiary;
  ...
  public class Floor : GraphicalElementT<Types.HostObject, DB.Floor>
  {
    public override GH_Exposure Exposure => GH_Exposure.tertiary;
  ...
  public class Roof : GraphicalElementT<Types.HostObject, DB.RoofBase>
  {
    public override GH_Exposure Exposure => GH_Exposure.tertiary;
  ...
  public class Wall : GraphicalElementT<Types.HostObject, DB.Wall>
  {
    public override GH_Exposure Exposure => GH_Exposure.tertiary;
