...
namespace RhinoInside.Revit.GH.Parameters
{
  ...
  public class Vertex : GeometryObject<Types.Vertex, ARDB.Point>
  {
    ...
    public Vertex() : base("Vertex", "Vertex", "Contains a collection of Revit vertices", "Params", "Revit") { }
  ...
  public class Edge : GeometryObject<Types.Edge, ARDB.Edge>
  {
    ...
    public Edge() : base("Edge", "Edge", "Contains a collection of Revit edges", "Params", "Revit") { }
  ...
  public class Face : GeometryObject<Types.Face, ARDB.Face>
  {
    ...
    public Face() : base("Face", "Face", "Contains a collection of Revit faces", "Params", "Revit") { }
