...
namespace RhinoInside.Revit.GH.Parameters
{
  public class CompoundStructure : Param<Types.CompoundStructure>
  {
    ...
    public CompoundStructure() : base("Compound Structure", "CStructure", "Represents a Revit compound structure.", "Params", "Revit Primitives") { }
  }
  ...
  public class CompoundStructureLayer : Param<Types.CompoundStructureLayer>
  {
    ...
    public CompoundStructureLayer() : base("Compound Structure Layer", "CSLayer", "Represents a Revit compound structure layer.", "Params", "Revit Primitives") { }
  }
}
