...
namespace RhinoInside.Revit.GH.Parameters
{
  ...
  public class View : Element<Types.IGH_View, ARDB.View>
  {
    ...
    protected override void Menu_AppendPromptOne(ToolStripDropDown menu)
    {
      ...
      using (var collector = new ARDB.FilteredElementCollector(Revit.ActiveUIDocument.Document))
      {
        ...
        else RefreshViewsList(listBox, ARDB.ViewFamily.Invalid);
      }
    ...
    private void RefreshViewsList(ListBox listBox, ARDB.ViewFamily viewFamily)
    {
  ...
  public class ViewFamilyType : ElementType<Types.IGH_ViewFamilyType, ARDB.ViewFamilyType>
  {
