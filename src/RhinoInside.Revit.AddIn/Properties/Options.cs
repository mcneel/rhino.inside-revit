...
namespace RhinoInside.Revit.AddIn.Properties
{
  ...
  public class AddInOptions
  {
    ...
    private bool _isolateSettings = Core.IsolateSettings;
    ...
    private bool _useHostLanguage = Core.UseHostLanguage;
    ...
    private bool _keepUIOnTop = Core.KeepUIOnTop;
    ...
    // de/serializer
    private static readonly XmlSerializer _xml = new XmlSerializer(typeof(AddInOptions), new Type[] { typeof(AddInCustomOptions) });
